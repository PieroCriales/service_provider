    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 col-sm-6">
                <h3></h3>
                <div class="col-12">
                    <img src="{{asset('storage').'/'.$service->picture_path}}" class="product-image"
                        alt="Product Image">
                </div>
            </div>
                    ...
                    <div class="col-md-7">
                        <div class="card card-dark">
                            <div class="card-body box-profile">
                                ...
                                <h3 class="profile-username text-center"> {{ $service->user->profile->firstname ?? '' }}
                                    {{ $service->user->profile->lastname ?? '' }} </h3>
                    ...
                    <div class="mt-4">
                        <div class="btn btn-primary btn-lg btn-flat">
                            ...
                            <button class="btn btn-primary" type="button" data-toggle="modal"
                                data-target="#exampleModalCenter">Adquirir Servicio</button>
                        </div>
                        <!-- Modal -->
                ...
                <nav class="w-100">
                    <div class="nav nav-tabs" id="product-tab" role="tablist">
                        <a class="nav-item nav-link active" id="product-desc-tab" data-toggle="tab" role="tab"
                            aria-controls="product-desc" aria-selected="true" href="#comment">Comentarios</a>
                        <a class="nav-item nav-link" id="product-desc-tab" data-toggle="tab" role="tab"
                            aria-controls="product-desc" aria-selected="true" href="#rating">Calificaciones</a>
                    </div>
                </nav>
                ...
                <div class="tab-content p-3">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('post.store') }}" method="post">
                                    ...
                                    <div class="input-group input-group-sm mb-0">
                                        <input class="form-control form-control-sm" type="text" name="body" id=""
                                            placeholder="Consultanos aquí...">
                                        <input type="hidden" name="service_id" id="" value="{{ $service->id }}">
                    ...
                    <div id="rating" class="tab-pane fade">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="container">
                                    <form class="form-horizontal" action="{{ route('rating.update', $rating->id) }}"
                                        method="post">
                                        @method('PUT')
                                        {{csrf_field()}}
                                        <p><b>Califique el servicio aqui :</b></p>
                                        <input id="input-1" name="rating_star" class="rating rating-loading"
                                            data-min="0" data-max="5" data-step="1" value="">
                                        <div class="input-group input-group-sm mb-0">
                                            <input class="form-control form-control-sm" type="text" name="comment" id=""
