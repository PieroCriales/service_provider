...
@section('content_header')
    <h1 class="m-0 text-dark">Modificar</h1>
@stop
        ...
        <div class="col-md-8">
            <div class="card card-secondary">
                ...
                <div class="card-body">
                    ...
                    <h4 class="my-3">Número de Orden: #{{ $purchase->code }}</h4>
                    <h4 class="my-3">Fecha Programada Actualmente: {{ $purchase->due_date }}</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="modal-body">
                                <form class="form-horizontal" action="{{ route('purchase.update', $purchase) }}" method="POST">
                                    @csrf
                                    @method('put')
